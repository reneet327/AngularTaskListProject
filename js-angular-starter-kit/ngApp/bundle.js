...
myApp.controller('tListCtrl', function ($scope) {
  ...
  $scope.tasks = [{ item: "Brush Teeth", completed: false }, { item: "Take Shower", completed: false }, { item: "Get Dressed", completed: false }, { item: "Eat Breakfast", completed: false }];
  ...
  $scope.rmvItem = function (event) {
    ...
    $scope.tasks.splice(event.target.checked, 1);
    // }
    // }
  };
});
